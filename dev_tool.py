...
def create_argument_parser():
    ...
    """
    parser = argparse.ArgumentParser(description='Group 8 DevTool\nCreate a bar graph for code coverage using a '
                                                 'coverage table file generated by for example lcov.')
    ...
    parser.add_argument('-nc', '--no_complete', default=False, required=False, action='store_true',
                        help='Will not generate a graph with ratio for all files, default False.')
    parser.add_argument('-s', '--separator', default='|', type=str, required=False,
                        help='Input file column separator, default "|".')  # Experimental
    parser.add_argument('-sr', '--skip_rows', default=1, type=int, required=False,
                        help='Lines to skip in input file, default 1.')  # Experimental
    return parser
